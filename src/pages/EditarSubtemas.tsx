...
import SubtemasOrderManager from '../components/SubtemasOrderManager';
    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <div style={s.editBanner}>
          ...
          <div>
            <strong>Orden de subtemas</strong>
            <p style={s.editBannerHint}>
              Selecciona un tema y reordena sus subtemas. Los cambios no se aplican hasta que pulses <strong>Guardar orden</strong>.
            </p>
          </div>
        </div>

        <SubtemasOrderManager
          title="Subtemas"
          subtitle="Orden actual de los subtemas del tema seleccionado"
        />
      </main>
