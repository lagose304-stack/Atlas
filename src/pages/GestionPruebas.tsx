    ...
    const timeoutId = window.setTimeout(() => {
      const fetchPruebas = async () => {
        ...
        let query = supabase
          ...
          .select(
            scope === 'parcial'
              ? 'id, nombre, instrucciones, scope, parcial_key, estado, created_at'
              : scope === 'tema'
                ? 'id, nombre, instrucciones, scope, parcial_key, estado, created_at, tema:temas(id, nombre)'
                : 'id, nombre, instrucciones, scope, parcial_key, estado, created_at, tema:temas(id, nombre), subtema:subtemas(id, nombre)'
          )
          .eq('scope', scope)
