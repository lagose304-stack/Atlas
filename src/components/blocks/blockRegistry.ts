...
export const BLOCK_REGISTRY: Record<BlockType, BlockDefinition> = {
  ...
  histology_generalities: {
    meta: { label: 'Generalidades del Tejido', icon: 'GEN', description: 'Introducción, puntos clave e imagen de referencia.', color: '#4f46e5' },
    schemaVersion: 1,
    defaultContent: {
      title: 'Generalidades del Tejido',
      badge_text: 'Generalidades',
      intro_text: '',
      image_url: '',
      image_badge: '🔬 Micrografía de Referencia',
      points_count: '4',
      point_1_title: 'Origen Embriológico',
      point_1_desc: '',
      point_2_title: 'Avascularidad & Difusión',
      point_2_desc: '',
      point_3_title: 'Polaridad Celular',
      point_3_desc: '',
      point_4_title: 'Nomenclatura Específica',
      point_4_desc: '',
      lab_tip: '',
    },
  },
  histology_function: {
    meta: { label: 'Función Principal', icon: 'FUN', description: 'Explicación fisiológica, mecanismos e imagen.', color: '#0284c7' },
    schemaVersion: 1,
    defaultContent: {
      title: 'Función Principal del Tejido',
      badge_text: 'Función Principal del Tejido',
      description: '',
      image_url: '',
      image_badge: '⚡ Esquema Funcional',
      feats_count: '4',
      feat_1_title: 'Transporte y Difusión',
      feat_1_desc: '',
      feat_2_title: 'Permeabilidad Selectiva',
      feat_2_desc: '',
      feat_3_title: 'Protección / Barrera',
      feat_3_desc: '',
      feat_4_title: 'Mínima Resistencia',
      feat_4_desc: '',
      clinical_note: '',
    },
  },
  histology_morphology: {
    meta: { label: 'Criterios Morfológicos', icon: 'MORF', description: 'Guía de 5 criterios diagnósticos al microscopio.', color: '#0369a1' },
    schemaVersion: 1,
    defaultContent: {
      title: 'Criterios Morfológicos de Identificación',
      badge_text: 'Reconocimiento Microscópico',
      intro_text: '',
      image_url: '',
      image_badge: '🔬 Micrografía Morfológica',
      items_count: '5',
      item_1_title: 'Estratificación Celular',
      item_1_desc: '',
      item_2_title: 'Morfología Nuclear',
      item_2_desc: '',
      item_3_title: 'Espesor Citoplasmático',
      item_3_desc: '',
      item_4_title: 'Complejos de Unión',
      item_4_desc: '',
      item_5_title: 'Membrana Basal',
      item_5_desc: '',
      exam_tip: '',
    },
  },
  histology_locations: {
    meta: { label: 'Ubicaciones Anatómicas', icon: 'UBI', description: 'Distribución y localización en órganos y sistemas.', color: '#059669' },
    schemaVersion: 1,
    defaultContent: {
      title: 'Ubicaciones Anatómicas Clave',
      badge_text: 'Atlas Anatómico',
      intro_text: '',
      image_url: '',
      image_badge: '📍 Esquema Anatómico',
      items_count: '5',
      item_1_organ: 'Órgano 1',
      item_1_system: 'Sistema 1',
      item_1_desc: '',
      item_2_organ: 'Órgano 2',
      item_2_system: 'Sistema 2',
      item_2_desc: '',
      item_3_organ: 'Órgano 3',
      item_3_system: 'Sistema 3',
      item_3_desc: '',
      item_4_organ: 'Órgano 4',
      item_4_system: 'Sistema 4',
      item_4_desc: '',
      item_5_organ: 'Órgano 5',
      item_5_system: 'Sistema 5',
      item_5_desc: '',
      mnemotic_tip: '',
    },
  },
  histology_stains: {
    meta: { label: 'Tinciones Histológicas', icon: 'TINC', description: 'Colorimetría y técnicas de tinción en laboratorio.', color: '#9333ea' },
    schemaVersion: 1,
    defaultContent: {
      title: 'Tinciones Histológicas y Colorimetría',
      badge_text: 'Colorimetría & Laboratorio',
      intro_text: '',
      image_url: '',
      image_badge: '🎨 Muestra de Tinción',
      items_count: '5',
      item_1_name: 'Hematoxilina y Eosina (H&E)',
      item_1_cat: 'Tinción Rutinaria',
      item_1_result: '',
      item_2_name: 'Impregnación Argéntica',
      item_2_cat: 'Tinción Metálica',
      item_2_result: '',
      item_3_name: 'Tricrómico de Masson',
      item_3_cat: 'Tinción Diferencial',
      item_3_result: '',
      item_4_name: 'PAS (Ácido Periódico de Schiff)',
      item_4_cat: 'Histoquímica',
      item_4_result: '',
      item_5_name: 'Azul de Toluidina',
      item_5_cat: 'Metacromática',
      item_5_result: '',
      color_tip: '',
    },
  },
