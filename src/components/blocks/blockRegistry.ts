...
export const BLOCK_REGISTRY: Record<BlockType, BlockDefinition> = {
  ...
  exam_week: {
    meta: { label: 'Semana de exámenes', icon: 'EXAM', description: 'Banner de preparación y repaso para exámenes parciales.', color: '#0284c7' },
    schemaVersion: 1,
    defaultContent: {
      parcial: 'primer',
      eyebrow: 'Periodo de Evaluaciones',
      title: 'Semana de Exámenes: Primer Parcial',
      subtitle: '¡Mucho éxito en tus evaluaciones! Repasa los conceptos clave y practica con las placas del laboratorio.',
      image_url: '',
      image_caption: 'Modo estudio activado 🔬',
      btn_temario_text: 'Repasar temario',
      btn_evaluaciones_text: 'Evaluaciones prácticas',
      btn_temario_url: '/temario?parcial=primer',
      btn_evaluaciones_url: '/evaluaciones',
      exam_accent: '#0284c7',
      exam_bg: '#f0f8ff',
      exam_style: 'premium',
      exam_width: 'full',
      exam_image_position: 'right',
    },
  },
  list: {
