  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '0 12px 34px rgba(99, 102, 241, 0.06), inset 0 1px 0 #ffffff',
    ...
    >
      ...
      <div style={{ padding: 'clamp(20px, 3vw, 32px)', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            ...
            {hasKeyIdea && (
              <div
                style={{
                  borderRadius: '20px',
                  background: 'linear-gradient(145deg, #fcfaff 0%, #f5f3ff 60%, #ede9fe 100%)',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ fontSize: '0.88rem', fontWeight: 850, color: '#312e81', letterSpacing: '-0.01em' }}>
                    Idea clave
                  </span>
                </div>
                <div
        ...
        {hasBottomContent && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingTop: hasTopContent ? '14px' : '0', borderTop: hasTopContent ? '1px solid #e0e7ff' : 'none' }}>
            {/* Cabecera de los Puntos Clave */}
            {pointsTitle && pointsTitle.trim() !== '' && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Sparkles size={16} color="#6366f1" />
                <h4 style={{ margin: 0, fontSize: '1rem', fontWeight: 850, color: '#1e1b4b' }}>
                  {pointsTitle}
                </h4>
              </div>
            )}
                ...
                {validKeyPoints.map((point, index) => (
                  <div
                    ...
                    style={{
                      ...
                      flexDirection: 'column',
                      gap: '6px',
                      boxShadow: '0 3px 10px rgba(99, 102, 241, 0.04)',
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      {point.label && point.label.trim() !== '' && (
                        <strong style={{ fontSize: '0.86rem', color: '#1e293b', fontWeight: 800 }}>
                          {point.label}
                        </strong>
                      )}
                    </div>
            ...
            {labTip && labTip.trim() !== '' && (
              ...
              >
                ...
                <div style={{ color: '#000000', flex: 1 }}>{renderBoldText(labTip)}</div>
              </div>
            )}
          </div>
        )}
